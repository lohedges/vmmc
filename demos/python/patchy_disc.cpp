...
PyObject *box, *particles, *cells, *io, *patchyDisc;
...
int main(int argc, char** argv)
{
    ...
    dimension = 2;                          // dimension of simulation box
    ...
    maxInteractions = 3;                    // maximum number of interactions per particle
    ...
    // Create argument object.
    pArgs = Py_BuildValue("(IOd)", dimension, pBoxSize, 1 + 0.5*interactionRange);
    ...
    // Reference to patchy-disc object.
    pClass = PyObject_GetAttrString(pModule, "PatchyDisc");
    ...
    patchyDisc = PyObject_CallObject(pClass, pArgs);
