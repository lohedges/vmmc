...
#ifdef ISOTROPIC
#error lennard_jonesium.cpp cannot be linked to isotropic VMMC library!
#endif
...
PyObject *box, *particles, *cells, *io, *lennardJonesium;
...
int main(int argc, char** argv)
{
    ...
    maxInteractions = 100;                  // maximum number of interactions per particle
    ...
    // Reference to lennard-jonesium object.
    pClass = PyObject_GetAttrString(pModule, "LennardJonesium");
    ...
    lennardJonesium = PyObject_CallObject(pClass, pArgs);
...
double computeEnergy(unsigned int particle, const double* position, const double* orientation)
{
    ...
    PyObject *pResult = PyObject_CallMethodObjArgs(lennardJonesium,
    ...
    unsigned int particle2, const double* position2, const double* orientation2)
{
    ...
    // Execute Python callback.
    PyObject *pResult = PyObject_CallMethodObjArgs(lennardJonesium, pString, pParticle1,
    ...
    const double* position, const double* orientation, unsigned int* interactions)
{
    ...
    // Execute Python callback.
    PyObject *pResult = PyObject_CallMethodObjArgs(lennardJonesium, pString,
...
double getEnergy()
{
    ...
    // Execute Python callback.
    PyObject *pResult = PyObject_CallMethodObjArgs(lennardJonesium, pString, NULL);
