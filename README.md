...
2interface with Python code via the i[Python C API](https://docs.python.org/2/c-api/).
2Note that this code is intended to be used for illustrative purposes and
2avoids the use of additional dependencies (e.g. [NumPy](http://www.numpy.org).
2As such, it is likely that performance could be significantly improved.
